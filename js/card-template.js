...
function getStampImage() {
    return `
        <div style="position: absolute; top: 50%; right: -19px; transform: translateY(-50%); width: 50px; height: 50px; z-index: 10; display: flex; align-items: center; justify-content: center;">
            <img src="../tra.png" 
                 alt="ត្រា" 
